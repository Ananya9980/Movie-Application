package com.niit.gatewayserver.filter;
...
public class JwtFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        //created an object of HttpServletRequest
        HttpServletRequest httpServletRequest=(HttpServletRequest)servletRequest;
        HttpServletResponse httpServletResponse=(HttpServletResponse) servletResponse;

        //request has multiple Header, one of which is taking authorization.
        ...
        //Adding the claim information to the request object so to use in the protected resource
            //creating the request and adding in the claims
        httpServletRequest.setAttribute("claims",claims);

        //now request passing/Moving to the Protected resource.
        filterChain.doFilter(httpServletRequest,httpServletResponse);

    }
}

//filter perform preprocessing or postprocessing
